...
<template>
  <footer class="@container relative isolate overflow-hidden bg-[var(--color-primary)] py-16 text-[var(--color-surface)]">
    <div class="pointer-events-none absolute inset-0 -z-20 bg-[radial-gradient(circle_at_12%_0%,color-mix(in_srgb,var(--color-secondary)_22%,transparent),transparent_28%),linear-gradient(180deg,color-mix(in_srgb,var(--color-primary)_94%,var(--color-text)),var(--color-primary))]" />
    ...
    <div class="tenant-container grid gap-10 @3xl:grid-cols-2 @6xl:grid-cols-[1.1fr_0.8fr_1.1fr_0.8fr]">
      <div>
        <div class="flex items-center gap-3">
          <div class="relative grid size-11 place-items-center overflow-hidden rounded-lg bg-[var(--color-secondary)] text-[var(--color-primary)]">
            <span class="pointer-events-none absolute inset-0 bg-[var(--color-surface)] opacity-20 [mask-image:url(/backgrounds/eight-point-star.svg)] [mask-position:center] [mask-repeat:repeat] [mask-size:42px]" aria-hidden="true" />
        ...
        <p class="mt-6 max-w-xs text-sm font-semibold leading-6 text-[color:color-mix(in_srgb,var(--color-surface)_68%,transparent)]">
      ...
      <div v-if="footerLinks.length">
        ...
        <nav class="mt-5 grid gap-3 text-sm font-semibold text-[color:color-mix(in_srgb,var(--color-surface)_68%,transparent)]">
          <NuxtLink
      ...
      <div>
        ...
        <div class="mt-5 grid gap-4 text-sm font-semibold leading-6 text-[color:color-mix(in_srgb,var(--color-surface)_68%,transparent)]">
      ...
      <div>
        ...
        <div class="mt-6 flex items-center gap-3">
          <UButton
            ...
            class="rounded-full bg-[color:color-mix(in_srgb,var(--color-surface)_8%,transparent)] text-[color:color-mix(in_srgb,var(--color-surface)_68%,transparent)] hover:text-[var(--color-secondary)]"
            aria-label="Facebook"
          />
          <UButton
    ...
    <div class="tenant-container mt-14 flex flex-wrap items-center justify-between gap-3 border-t border-[color:color-mix(in_srgb,var(--color-surface)_12%,transparent)] pt-8 text-xs font-semibold text-[color:color-mix(in_srgb,var(--color-surface)_58%,transparent)]">
